...
dashtable_1 = dash_table.DataTable(#NOT USED - TABLE OF VARIABLES
    id="table1",
    columns=[
...
#Deleting some non desired data
...
metric_parentparam_drop1 = dcc.Dropdown(
        ...
        html.A(
            ...
            dbc.Row(
                [
                    dbc.Col(                        
                            html.Img(
                                src=app.get_asset_url("dashboard.png"), height="70px"
                            ),
                            width=1,
                    ),
                    dbc.Col(
                        [
                            html.Label("THIS IS A STANDARD DASHBOARD", id="label1"),
                            html.Label(
                                "Explore the data t extract some infomation out of it",
                                className="label2",
                            ),
                            html.Br(),
                            html.Label(
                                "Dashboard created by: Jonas Carvalho",
                                className="label2",
...
controls_club = dbc.Card(
    [
        dbc.Row(
            [html.Label("Choose a League:"), html.Br(), metric_parentparam_drop1,]
        ),
        dbc.Row(
            [
...
# cards_2 = dbc.Row(# CARDS - NOT USED
#     [
#         dbc.Card(
#             dbc.CardBody(
#                 [
                    ...
                    [
                        ...
                        dbc.Row(
                            [
                                dbc.Col(
                                    [
                                        dbc.Row(controls_param_1),
                                        dbc.Row(controls_param_2),
                                    ],
                                    sm=4,
                                ),
                            
                                dbc.Col(#Fisrt chart of first row
                                    dcc.Graph(id="graph_example"), sm=4, align="center"
                                ),
                                dbc.Col(#second chart of first row
                                    dcc.Graph(id="graph_example1"), sm=4, align="center"
                                ),
                            ],
                            justify="between",
                        ),
...
#END-FIRST CHART OF FIRST ROW======================================================

#SECONDD CHART FRST ROW=======================================================
    fig_c=fig
#END - SECONDD CHART FRST ROW=======================================================
